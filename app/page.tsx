...
export default function MeetingRequestPage() {
  return (
    <div className="min-h-screen bg-surface-warm dark:bg-[#0a0a0f] bg-grid-pattern dark:bg-grid-dark bg-grid overflow-x-hidden relative transition-colors duration-200">
      ...
      {/* Header - glass navbar, responsive on mobile */}
      <header className="sticky top-0 z-20 border-b border-zinc-200/80 dark:border-white/[0.08] bg-white/90 dark:bg-[#0a0a0f]/80 backdrop-blur-xl transition-colors duration-200">
        <div className="mx-auto max-w-content px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex flex-wrap items-center justify-between gap-3 sm:gap-4">
            ...
            {/* Email & phone: icon-only on mobile, full text from sm */}
            <div className="flex items-center gap-1 sm:gap-4 min-w-0 flex-shrink-0">
              ...
              >
                <svg
                  className="w-5 h-5 sm:w-4 sm:h-4 text-crypto-cyan flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden
                ...
                <span className="hidden sm:inline font-medium truncate">hello@infoendeavorconnect.com</span>
              </a>
              <a
            ...
            {/* Theme + CTA - always visible, CTA text short on mobile */}
